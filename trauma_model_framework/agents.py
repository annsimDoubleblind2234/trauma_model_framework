...
class SsAgent(mesa.Agent):
    def __init__(
        ...
        generation=-1, family=-1, epigenetic_symptoms=[],
    ):
        ...
        self.epigenetic_lifespan_decrease = 0
        self.epigenetic_lifespan_increase = 0
    ...
    def prenatal_trauma_create(self,eld):
        ...
        '''
        self.epigenetic_lifespan_decrease += eld
        self.epigenetic_lifespan_decrease = min(self.epigenetic_lifespan_decrease,0.2)
        # trigger is (gen + 3) b/c it is 2 generations after the agent currently
        # about to be birthed (prenatal)
        triggers = {'generation':self.generation+3,'age':0,'sex':self.sex}
        expression = ['prenatal_trauma_express',self.epigenetic_lifespan_decrease]
    ...
    def prepubecent_trauma_create(self,eli):
        ...
        '''
        self.epigenetic_lifespan_increase += eli
        self.epigenetic_lifespan_increase = min(self.epigenetic_lifespan_increase,0.2)
        triggers = {'generation':self.generation+2,'age':0}
        expression = ['prepubescent_trauma_express',self.epigenetic_lifespan_increase]
